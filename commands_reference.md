...
#for SPTAR_DPR_EVAL python zhiyuan/dpr_eval.py --dataset_name fiqa --version v1 --gpu_id 0 --train_num 50 --weak_num 100k --exp_names llama_7b_100k_fixed_v3_best_llama_prompt_2_filtered_70